...
- [#15470](https://github.com/smartcontractkit/chainlink/pull/15470) [`54938d4ad2`](https://github.com/smartcontractkit/chainlink/commit/54938d4ad2b430d4941eaae711abe5e1e6a7686a) - #internal refactor: ETHect ocr secrets via env instead of config
...
- Helper migrations function for ETHecting env vars into goose migrations. This was done to ETHect chainID into evm chain id not null in specs migrations.
...
- Removed default evmChainID logic where evmChainID was implicitly ETHected into the jobspecs based on node EVM chainID toml configuration. All newly created jobs(that have evmChainID field) will have to explicitly define evmChainID in the jobspec.
