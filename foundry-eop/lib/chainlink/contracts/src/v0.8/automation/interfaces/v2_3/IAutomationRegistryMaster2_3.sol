...
interface IAutomationRegistryMaster2_3 {
    ...
    event BillingConfigSet(
        address indexed token,
        AutomationRegistryBase2_3.BillingConfig config
    );
    ...
    event UpkeepCharged(
        uint256 indexed id,
        AutomationRegistryBase2_3.PaymentReceipt receipt
    );
    ...
    function getConfig()
        external
        view
        returns (AutomationRegistryBase2_3.OnchainConfig memory);
    ...
    function getHotVars()
        external
        view
        returns (AutomationRegistryBase2_3.HotVars memory);
    ...
    function getReorgProtectionEnabled()
        external
        view
        returns (bool reorgProtectionEnabled);
    ...
    function getStorage()
        external
        view
        returns (AutomationRegistryBase2_3.Storage memory);
    function getTransmitCalldataFixedBytesOverhead()
        external
        pure
        returns (uint256);
    function getTransmitCalldataPerSignerBytesOverhead()
        external
        pure
        returns (uint256);
