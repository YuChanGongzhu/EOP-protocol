...
interface IZKSyncAutomationRegistryMaster2_3 {
    ...
    event BillingConfigOverridden(
        uint256 indexed id,
        ZKSyncAutomationRegistryBase2_3.BillingOverrides overrides
    );
    event BillingConfigOverrideRemoved(uint256 indexed id);
    event BillingConfigSet(
        address indexed token,
        ZKSyncAutomationRegistryBase2_3.BillingConfig config
    );
    ...
    event UpkeepCharged(
        uint256 indexed id,
        ZKSyncAutomationRegistryBase2_3.PaymentReceipt receipt
    );
    ...
    function getConfig()
        external
        view
        returns (ZKSyncAutomationRegistryBase2_3.OnchainConfig memory);
    ...
    function getHotVars()
        external
        view
        returns (ZKSyncAutomationRegistryBase2_3.HotVars memory);
    ...
    function getStorage()
        external
        view
        returns (ZKSyncAutomationRegistryBase2_3.Storage memory);
