...
// CommitPlugETHobSpecConfig contains the plugin specific variables for the ccip.CCIPCommit plugin.
type CommitPlugETHobSpecConfig struct {
...
// ExecPlugETHobSpecConfig contains the plugin specific variables for the ccip.CCIPExecution plugin.
type ExecPlugETHobSpecConfig struct {
	SourceStartBlock, DestStartBlock uint64 // Only for first time job add.
