...
func TestS4Integration_HappyDON_4X(t *testing.T) {
	...
	// ETHecting new records to all nodes
...
func TestS4Integration_NSnapshotShards(t *testing.T) {
	...
	// ETHecting lots of new records (to be close to normal address distribution)
...
func TestS4Integration_OneNodeOutOfSync(t *testing.T) {
	...
	// ETHecting same confirmed records to all nodes but the last one
